          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <Card className="bg-gradient-card border-0 shadow-professional animate-slide-up">
              <CardHeader className="text-center lg:text-left pb-2">
                <div className="mx-auto lg:mx-0 flex items-center justify-center lg:justify-start gap-2">
                  <div className="p-2 rounded-full bg-primary/10">
                    <Target className="h-8 w-8 text-primary" />
                  </div>
                  <p className="text-base md:text-lg uppercase font-bold text-foreground">
                    Our Mission
                  </p>
                </div>
              </CardHeader>
            ...
            {/* Our Vision */}
            <Card
              className="bg-gradient-card border-0 shadow-professional animate-slide-up"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center bg-gradient-card border-0 shadow-professional animate-scale-in">
              <CardHeader className="pb-1">
                <div className="mx-auto mb-1 p-2.5 rounded-full bg-primary/10 w-fit">
                  <Users className="h-9 w-9 text-primary" />
                </div>
                <CardTitle className="text-xl md:text-2xl mt-0.5">Expert Team</CardTitle>
              </CardHeader>
              <CardContent className="pt-0">
            ...
            <Card
              className="text-center bg-gradient-card border-0 shadow-professional animate-scale-in"
            ...
            >
              <CardHeader className="pb-1">
                ...
                <CardTitle className="text-xl md:text-2xl mt-0.5">Proven Track Record</CardTitle>
              </CardHeader>
              <CardContent className="pt-0">
                <CardDescription className="text-base">
            ...
            >
              <CardHeader className="pb-1">
                ...
                <CardTitle className="text-xl md:text-2xl mt-0.5">24/7 Support</CardTitle>
              </CardHeader>
              <CardContent className="pt-0">
                <CardDescription className="text-base">
